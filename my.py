...
# 修改成自己的配置！！！
class LangChainCFG:
    llm_model_name       = 'https://huggingface.co/THUDM/chatglm-6b-int4-qe/tree/main'            # 本地模型文件 or huggingface远程仓库
    embedding_model_name = 'https://huggingface.co/GanymedeNil/text2vec-large-chinese/tree/main'  # 检索模型文件 or huggingface远程仓库
